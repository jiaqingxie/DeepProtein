...
if __name__ == "__main__":
    ...
    train_fluo = FluorescenceDataset(path + '/ProB/data', 'train')
    valid_fluo = FluorescenceDataset(path + '/ProB/data', 'valid')
    test_fluo = FluorescenceDataset(path + '/ProB/data', 'test')
