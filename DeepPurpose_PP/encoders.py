...
# }
	def __init__(self, encoding, **config):
		...
		if encoding == 'Protbert':
			self.tokenizer = BertTokenizer.from_pretrained("Rostlab/prot_bert", do_lower_case=False)
			self.encoder = BertForMaskedLM.from_pretrained("Rostlab/prot_bert").to(device)
		#TODO: Prot-T5
		#TODO: Prost-T5
		#TODO: ProtAlbert
		#TODO: Prot_XL_Net
	...
	def forward(self, v):
		encoded_input = self.tokenizer(v, return_tensors='pt')
...
class DGL_GIN_InfoMax(nn.Module):
	...
	def __init__(self, predictor_dim=None):
		super( DGL_GIN_InfoMax, self).__init__()
